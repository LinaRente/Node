...
const User = require('./models').User; // pareil que const Usert = requiere('./models/user');
...
passport.serializeUser(User.serializeUser()); // Save the user.id ti the session
passport.deserializeUser(User.deserializeUser()); // Receive the user.id from session and fetch the User from the DB by its ID
...
app.post('/signup', (req, res) => {
    ...
    User.register(
        ...
        (err, user) => {
            if (err) {
                console.log('/sigup user register err', err);
